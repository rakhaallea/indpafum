...
const Navbar = () => {
    ...
    return (
        <nav className='fixed z-100 w-full px-4 md:px-8 mx-auto py-10 font-josefin-sans'>
            ...
            <ul className={`absolute top-28 right-4 lg:static z-99 flex-col gap-4 lg:flex-row lg:flex justify-between items-center w-1/2 mx-auto py-6 tracking-widest capitalize bg-[#252726] lg:bg-transparent lg:translate-y-0 transition-all duration-300 lg:transition-none ease-in-out ${!isActive ? "opacity-10 lg:opacity-100 translate-x-250" : "opacity-100 translate-0"}`}>
                {navLinks.map((nav) => (
